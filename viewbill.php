...
<form action="viewpayment.php?id='.$row['id'].'" method="post">

<p style="margin: 0px;font-size: 18px;"><b>Name:</b> <?php echo $lname.',&nbsp;' .$fname.'&nbsp;'?></p> 
...
<p style="float: left; font-size: 14px; font-weight: bold; margin-top: 4px; margin-right: 10px; margin-left: 510px;">Billing Date:</p>
 ...
 <input type="text" name="duedate" id="duedate" value="" placeholder="ex. 17-Oct-17" style="width: 117px; float: left;">
  <table style="text-align: center;" class="table table-bordered">
    <thead>
    <tr>
    <th style="width: 8%;text-align:center;">Previous Reading</th>
    <th style="width: 8%; text-align:center;">Present Reading</th>
    <th style="width: 8%; text-align:center;">Consumption</th>
    ...
    <th style="width: 8%; text-align:center;">Reading Date</th>
 ...
 <?php
$id =$_REQUEST['id'];
$result = mysqli_query($con, "SELECT * FROM bill WHERE owners_id='$id' ORDER BY id DESC");
while($row = mysqli_fetch_array($result))
  ...
  echo "<td>" . $status . "</td>";
 echo "<td><a class='btn btn-info' name='submit' id='submit' style='background-color: #46b1e4;' href='viewpayment.php?id=".$row['id']."'>Preview</a> ";
echo "<a class='btn btn-success' rel='facebox' href='editbill.php?id=".$row['id']."'>Edit</a> ";
 echo "<a class='btn btn-warning' data-toggle='modal' href='delbill.php?id=".$row['id']."'>Delete</a></td>";
  echo "</tr>";
  }
?>
